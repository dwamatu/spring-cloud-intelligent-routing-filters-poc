 ...
 * Time: 21:26
 */
public class DecryptionFilter extends ZuulFilter {
    @Override
    ...
    public Object run() throws ZuulException {
        ...
        handleDecryption(context, encryptionType);
     ...
     */
    private void handleDecryption(RequestContext context, String encryptionType) {
